...
let discount_percentage = parseInt(prompt("How much discount you are offering on this product?"));
function calculateDiscountedAmount(prod_price, discount_percentage) {
...
let discounted_amount = calculateDiscountedAmount(prod_price, discount_percentage);
